    ...
    <div className="auth-bg">
      ...
      <div className="auth-card animate-fade-in">
        ...
        <div style={{ textAlign: 'right', marginBottom: '20px' }}>
          <a href="#" style={{ color: '#ff9e42', fontSize: '12px' }}>Forgot password?</a>
        </div>
        ...
        <div style={{ display: 'flex', gap: '10px', justifyContent: 'center' }}>
          <button className="btn-ghost" style={{ padding: '10px 20px', display: 'flex', alignItems: 'center', gap: '8px', fontSize: '13px' }}>
